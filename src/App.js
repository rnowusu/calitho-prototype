  ...
  render() {
    ...
    return (
      <div className="App">
        <div className="panels" id="panelslider"
          ...
          <div className="panel" id="services" style={{backgroundImage: `url("https://calitho.brick.agency/wp-content/uploads/sites/40/2018/11/feature-image-services-thin.jpg")`, borderRight: "1px solid black",
             ...
             <div className="copybox" style={{color: "white", margin: "auto", maxWidth: "90%"}}>
              ...
              <div className="additional_text ">Id quod mazim placerat facer possim assum typi non habent claritatem insitam est usus legentis in. Lectorum mirum est notare quam littera gothica quam nunc putamus parum.
              </div>
            </div>
          ...
          <div className="panel" id="about-2" style={{backgroundImage: `url("https://calitho.brick.agency/wp-content/uploads/sites/40/2018/11/feature-image-about-thin.jpg")`, borderRight: "1px solid black",
             ...
             <div className="copybox" style={{color: "white", margin: "15vh auto auto auto", maxWidth: "90%"}}>
               <h2>About</h2>
               <div className="text" style={{color: "inherit"}}>
        ...
        <div className="menu" style={{position: "fixed", zIndex: "2", background: "white",
        ...
        <div className="hamburger" style={{position: 'absolute', right: "4vh", top: "3vh", background: "#fff",
        ...
        <div className="arrows">
          <IoIosArrowDropleft currentColor="white" strokeWidth={"4px"}/>
          <IoIosArrowDropright currentColor="white" strokeWidth={"4px"}/>
        </div>
